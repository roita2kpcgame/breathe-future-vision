  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 relative">
      <div className="text-center max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-6xl md:text-8xl font-bold text-[#263238] mb-6 leading-tight">
            Breathe the
          ...
          <p className="text-xl md:text-2xl text-[#263238]/80 mb-8 max-w-4xl mx-auto leading-relaxed">
            AI-powered air pollution monitoring from space using ISRO satellite data, 
            machine learning, and real-time ground sensors to protect public health
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
          <Button 
            onClick={scrollToMap}
            className="bg-[#00C853] hover:bg-[#00C853]/90 text-white px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
          >
            Explore Live Data
          </Button>
          <Button 
            variant="outline"
            className="border-[#263238] text-[#263238] hover:bg-[#263238] hover:text-white px-8 py-4 text-lg rounded-full transition-all duration-300"
          >
            View AI Predictions
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/30 transition-all duration-300">
            <div className="text-3xl font-bold text-[#FF6F00] mb-2">95%</div>
